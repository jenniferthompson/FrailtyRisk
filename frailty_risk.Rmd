...
prob_cohort <- function(
  ...
  return(1 / predict(prob_mod, type = "fitted"))
}

## Get weights for each time point
brainmind.oneobs$wts_3m <- prob_cohort(cohort_var = "cohort_3m")
brainmind.oneobs$wts_12m <- prob_cohort(cohort_var = "cohort_12m")
