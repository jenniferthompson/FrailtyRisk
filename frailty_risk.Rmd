...
**Overview:** Worse dependence and disability, less education and a *lower* modified mean SOFA score in the ICU are associated with worse frailty at both 3 and 12 months after discharge among ICU survivors. In addition, worse comorbidities and discharge to a facility are associated with worse frailty at 3 months, but not at 12 months; whether this is due to a true easing of effect or dropout of the most frail patients is a matter for further consideration. Among those who survived and were assessed at 12 months, older age is an additional risk factor for worse frailty at that time point.
...
```{r plots_3m}
multiplot(plotlist = cfs_plots_3m, layout = matrix(1:12, nrow = 3, byrow = TRUE))
...
```{r plots_12m}
multiplot(plotlist = cfs_plots_12m, layout = matrix(1:12, nrow = 3, byrow = TRUE))
