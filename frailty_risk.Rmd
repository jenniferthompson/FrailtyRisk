...
1. Baseline and in-hospital characteristics *and* CFS of any patient with CFS available at a) 3 months and b) 12 months (`r table_nums("describe_3m", cite = TRUE)` and `r table_nums("describe_12m", cite = TRUE)`), stratified by CFS at that time point
