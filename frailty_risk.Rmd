...
1. Baseline and in-hospital characteristics *and* CFS of any patient with CFS available at a) 3 months and b) 12 months (`r table_nums("describe_3m", display = TRUE)` and `r table_nums("describe_12m", display = "cite")`), stratified by CFS at that time point
